...
export interface StoryActOutline {
  title: string;
  summary: string;
  beats: string[];
}

export interface StoryCluePlan {
  id: string;
  description: string;
  payoff: string;
  foreshadowingBeat?: string;
}

export interface StoryMisdirectionPlan {
  id: string;
  technique: string;
  description: string;
  resolution: string;
...
export interface StoryOutlinePlan {
  topic: string;
  acts: StoryActOutline[];
  clues: StoryCluePlan[];
  misdirections: StoryMisdirectionPlan[];
  tone?: string;
...
export interface StoryReviewNote {
  id: string;
...
export interface StoryRevisionPlan {
  id: string;
  summary: string;
  actions: string[];
}
